...
module "vpccreate" {
  source = "git::ssh://git@github.com:vinodhmvm/intchallenge//tf-modules/vpc-stack"
...
module "web-stack" {
  source              = "git::ssh://git@github.com:vinodhmvm/intchallenge//tf-modules/ec2-stack"
  stackname           = "web"
  amis                = "${var.ami_id}"
...
module "db-stack" {
  source                    = "git::ssh://git@github.com:vinodhmvm/intchallenge//tf-modules/rds-stack"
